...
jobAliases =
  ...
  '06scripts'  : 'LS DEPLOY NWLTEST06 Scripts (trunk)'
  ...
  '10scripts'  : 'WO DEPLOY NWLTEST10 Scripts (trunk)'
  ...
  '17admin'    : 'NWLTEST17 DEPLOY Admin (trunk)'
  '17content'  : 'NWLTEST17 DEPLOY Content (trunk)'
  '17ecomm'    : 'NWLTEST17_DEPLOY_Commerce_trunk'
  '17rws'      : 'NWLTEST17 DEPLOY Corp Regional (trunk)'
  '17scripts'  : 'NWLTEST17 Deploy Scripts (trunk)'
  '17sites'    : 'NWLTEST17 DEPLOY Sites (trunk)'
  ...
  'LSUATscripts' : 'LS DEPLOY LSUAT Scripts (trunk)'
